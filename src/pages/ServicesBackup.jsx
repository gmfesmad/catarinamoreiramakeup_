...
const services = [
  {
    ...
    description: (
      <>
        ...
        <p>
          <strong>Reserva da Data</strong>
          <br />
          Tudo começa aqui! Após o envio do orçamento e das condições de reserva, a data fica oficialmente reservada na
          agenda.
        </p>
        <p>
          <strong>Prova de Maquilhagem</strong>
          <br />
          Este é um momento totalmente dedicado a conhecer a identidade da noiva e o estilo do casamento. Juntas,
          criamos a maquilhagem ideal para o grande dia.
        </p>
        <p>
          <strong>Organização da Timeline</strong>
          <br />
          Criação e envio de um horário e planeamento da preparação da noiva e convidadas, garantindo tranquilidade e
          tempo suficiente para cada etapa.
        </p>
        <p>
          <strong>Dia do Casamento</strong>
          <br />
          No grande dia, estou presente para criar a maquilhagem perfeita e acompanhar todos os momentos, nomeadamente a
